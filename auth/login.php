    ...
    <main class="my-form">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header border border-dark" style="background: linear-gradient(#4FA095, #0D4C92);">
                        ...
                        <div class="card-body border border-dark">
                            <form name="my-form" action="login.php" method="post">
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn " onClick="myFunction()" style="background-color:#4FA095; border-color: white;color:white" name="login" value="Login">
                                        Login
                                    </button>
                                </div>
                                <br>
                                <div class="col-md-6 offset-md-4">
                                    <label id="forgotPassword"><a id='link' href=forgotpassword.php><b style="color:#0E0220"> Forgot your password ?</b></a></label>
                                    <br>
                                    <label id="account"><a id='link' href="registration.php"><b style="color:#0E0220">Create New Account</b></a></label>
                                </div>
                            </form>
                        </div>
                    </div>
...
if (isset($_POST['login'])) {
    ...
    echo "<script>window.open('../temp/index1.php?buyer_id=$id','_self')</script>";
}
