	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
					<div class="card-header" style="background: linear-gradient(#4FA095, #0D4C92);"><h4 style="font-style:bold;color:white">Register</h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="registration.php" method="post">
								...
								<div class="form-group row">
									<label for="present_address" class="col-md-4 col-form-label text-md-right"><i class="fas fa-home mr-2"></i><b>Hostel block & Room No.</b></label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="account2" class="col-md-4 col-form-label text-md-right"><i class="fas fa-pencil-alt mr-2"></i><b>Registration Number</b></label>
									<div class="col-md-6">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary"  style="background-color:#4FA095;color:white" name="register" value="Register">
										Register
									</button>
								</div>
							</form>
...
if (isset($_POST['register'])) {
	...
	if (strcmp($password, $confirmpassword) == 0) {
		...
		$query = "insert into buyerregistration (buyer_name,buyer_phone,buyer_addr,buyer_pan,buyer_mail,buyer_username,buyer_password)
